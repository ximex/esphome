...
RF24_POWER_LEVELS = {
    "MIN": Rf24PowerLevel.RF24_POWER_LEVEL_MIN,
    "LOW": Rf24PowerLevel.RF24_POWER_LEVEL_LOW,
    "HIGH": Rf24PowerLevel.RF24_POWER_LEVEL_HIGH,
    "MAX": Rf24PowerLevel.RF24_POWER_LEVEL_MAX,
}

RemoteType = milight_ns.enum("RemoteType", is_class=True)
REMOTE_TYPES = {
    "rgbw": RemoteType.REMOTE_TYPE_RGBW,
    "cct": RemoteType.REMOTE_TYPE_CCT,
    "rgb_cct": RemoteType.REMOTE_TYPE_RGB_CCT,
    "rgb": RemoteType.REMOTE_TYPE_RGB,
    "fut020": RemoteType.REMOTE_TYPE_FUT020,
    "fut089": RemoteType.REMOTE_TYPE_FUT089,
    "fut091": RemoteType.REMOTE_TYPE_FUT091,
}


def validate_group_id(config: ConfigType) -> ConfigType:

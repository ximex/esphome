...
enum class Rf24PowerLevel : uint8_t {
  RF24_POWER_LEVEL_MIN = nrf24::RF_POWER_MIN,
  RF24_POWER_LEVEL_LOW = nrf24::RF_POWER_LOW,
  RF24_POWER_LEVEL_HIGH = nrf24::RF_POWER_HIGH,
  RF24_POWER_LEVEL_MAX = nrf24::RF_POWER_MAX,
};
...
struct LightRegistration {
  ...
  uint8_t group_id{0};
  uint8_t radio_config_index{0};
  RemoteType remote_type{RemoteType::REMOTE_TYPE_RGBW};
};
...
class MiLightHub : public Component,
 ...
 protected:
  ...
  Rf24PowerLevel rf24_power_level_{Rf24PowerLevel::RF24_POWER_LEVEL_MAX};

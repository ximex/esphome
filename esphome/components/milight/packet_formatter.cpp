...
const LogString *remote_type_to_string(RemoteType type) {
  switch (type) {
    case RemoteType::REMOTE_TYPE_RGBW:
      return LOG_STR("RGBW");
    case RemoteType::REMOTE_TYPE_CCT:
      return LOG_STR("CCT");
    case RemoteType::REMOTE_TYPE_RGB_CCT:
      return LOG_STR("RGB_CCT");
    case RemoteType::REMOTE_TYPE_RGB:
      return LOG_STR("RGB");
    case RemoteType::REMOTE_TYPE_FUT020:
      return LOG_STR("FUT020");
    case RemoteType::REMOTE_TYPE_FUT089:
      return LOG_STR("FUT089");
    case RemoteType::REMOTE_TYPE_FUT091:
      return LOG_STR("FUT091");
    default:
...
static bool decode_rgbw(const uint8_t *packet, uint8_t length, ReceivedCommand &out) {
  ...
  out.remote_type = RemoteType::REMOTE_TYPE_RGBW;
...
static bool decode_cct(const uint8_t *packet, uint8_t length, ReceivedCommand &out) {
  ...
  out.remote_type = RemoteType::REMOTE_TYPE_CCT;
  out.device_id = (packet[1] << 8) | packet[2];
...
static bool decode_rgb(const uint8_t *packet, uint8_t length, ReceivedCommand &out) {
  ...
  out.remote_type = RemoteType::REMOTE_TYPE_RGB;
  out.device_id = (packet[1] << 8) | packet[2];
  out.group_id = 0;
  out.sequence = packet[5];
...
static bool decode_fut020(const uint8_t *packet, uint8_t length, ReceivedCommand &out) {
  ...
  out.remote_type = RemoteType::REMOTE_TYPE_FUT020;
  out.device_id = (packet[1] << 8) | packet[2];
  out.group_id = 0;
  out.sequence = packet[5];
...
static void decode_rgb_cct_v2(uint8_t cmd, uint8_t arg, ReceivedCommand &out) {
  out.remote_type = RemoteType::REMOTE_TYPE_RGB_CCT;
  uint8_t num_groups = 4;
...
static void decode_fut089_v2(uint8_t cmd, uint8_t arg, ReceivedCommand &out) {
  out.remote_type = RemoteType::REMOTE_TYPE_FUT089;
  uint8_t num_groups = 8;
...
static void decode_fut091_v2(uint8_t cmd, uint8_t arg, ReceivedCommand &out) {
  out.remote_type = RemoteType::REMOTE_TYPE_FUT091;
  uint8_t num_groups = 4;
